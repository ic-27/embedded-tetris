...
all: main.c drivers/src/display_driver.c
	$(CC) -Wall -Wextra -Os -mmcu=atmega32 -o $(OUTPUT) main.c drivers/src/audio_driver.c drivers/src/display_driver.c src/button_handler.c drivers/src/bt_driver.c src/tetris.c src/display.c src/movement.c $(INC_PARAMS) 
upload: main.elf
