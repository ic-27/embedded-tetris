...
INC=$(DIR1) $(DIR2) $(DIR3) $(DIR4) $(DIR5) $(DIR6)
...
all: main.c display_driver/display_driver.c
	$(CC) -Os -mmcu=atmega32 -o $(OUTPUT) main.c drivers/audio_driver/audio_driver.c display_driver/display_driver.c button_handler/button_handler.c drivers/bt_driver/bt_driver.c $(INC_PARAMS) 
upload: main.elf
